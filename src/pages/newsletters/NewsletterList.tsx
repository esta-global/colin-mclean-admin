...
export function NewsletterList() {
  ...
  useEffect(
    function () {
      async function getData() {
        setLoading(true);
        let url = `/newsletters?page=${pagination.page}&limit=${pagination.limit}`;
  ...
  const columns: Column<Record>[] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: ({ value }: any) => {
          const subscriptionStatus: SubscriptionStatus = value;
          return (
            <>
          ...
          return (
            <div className="d-flex gap-1">
              <Link
                ...
                to={{
                  pathname: `/newsletters/edit/${value}`,
                }}
              >
  ...
  async function handleDeleteData(recordId: string | string[]) {
    ...
    if (Array.isArray(recordId)) {
      apiResponse = await remove(`/newsletters`, recordId);
    } else {
      apiResponse = await remove(`/newsletters/${recordId}`);
    }
        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">Newsletter Emails</h4>
            </div>
            <div>
              <Link
                to={"/newsletters/add"}
