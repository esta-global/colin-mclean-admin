...
export function EditGalleryImage() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await put(`/galleryImages/${id}`, newValue);
    ...
    function () {
      async function getData(id: string) {
        ...
        if (apiResponse?.status == 200) {
          ...
          delete apiData._id;
          if (apiData.galleryCategory) {
            apiData.galleryCategory = {
              label: apiData.galleryCategory?.name,
              value: apiData.galleryCategory?._id,
            };
          }

          if (apiData?.images) {
            setSelectedImages(apiData?.images || []);
          }
          setValues(apiData);
        } else {
          toast.error(apiResponse?.message);
          ...
          <div className="col-md-12 grid-margin">
            <div className="d-flex justify-content-between align-items-center">
              <div className="d-flex gap-2">
                <GoBackButton />
                <h4 className="font-weight-bold mb-0">Update Gallery Image</h4>
              </div>
              {/* <div>
              <button
                type="button"
              ...
              <div className="card rounded-2 mt-4">
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="">
                      <SubmitButton loading={false} text="Update Gallery" />
                    </div>
                  </div>
                </div>
              </div>
