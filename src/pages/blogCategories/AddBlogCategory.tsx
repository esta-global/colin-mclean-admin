...
import { generateSlug, post } from "../../utills";
...
export function AddBlogCategory() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await post("/blogCategories", newValue, true);
    ...
    <div className="content-wrapper blog-category-form-page">
      <div className="blog-category-form-header">
        <div className="blog-category-form-header__content">
          ...
          <p>
            Create a category that keeps posts organized and helps customers
            discover related content faster.
          </p>
        </div>
        <div className="blog-category-form-header__meta">
          <span className="blog-category-form-pill">New category</span>
          <span className="blog-category-form-note">Slug auto-generates</span>
        </div>
      </div>
          ...
          >
            ...
            <div className="blog-category-sticky-actions">
              <div>
                ...
                <span>Save this category to use it on blog posts.</span>
              </div>
              <SubmitButton loading={loading} text="Add Category" />
            </div>
          </form>
        </div>
      </div>
