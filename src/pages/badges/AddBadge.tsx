...
import {
  ...
  badgeSchema,
  BadgeValues,
} from "../../validationSchemas/badgeSchema";
  ...
  const { values, errors, touched, handleBlur, handleChange, handleSubmit } =
    useFormik({
      onSubmit: async function (
        values: BadgeValues,
        helpers: FormikHelpers<BadgeValues>
      ) {
        setLoading(true);

        const apiResponse = await post("/badges", values, true);
        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">Add Thickness</h4>
            </div>
            {/* <div>
              <button
                type="button"
          ...
          <div className="card rounded-2">
            <div className="card-body">
              <form className="forms-sample" onSubmit={handleSubmit}>
                ...
                <SubmitButton loading={false} text="Add Badge" />
              </form>
            </div>
          </div>
        </div>
