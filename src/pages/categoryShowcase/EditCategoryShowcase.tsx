...
export function EditCategoryShowcase() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await put(`/categoryShowcase/${id}`, values);
        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">Edit Category Showcase</h4>
            </div>
            {/* <div>
              <button
                type="button"
