...
export function TermAndConditionspage() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      const apiResponse = await post("/termAndConditions", payload, true);
      ...
      <div className="content-wrapper terms-admin-page">
        <div className="terms-page-header">
          <div className="terms-page-header__content">
            ...
            <p>
              Update the legal content, SEO title, description, and search
              keywords shown on the storefront terms page.
            </p>
          </div>
