...
} from "../../validationSchemas/materialSchema";
...
export function EditMaterial() {
  ...
  const {
    ...
    onSubmit: async function (
      ...
      helpers: FormikHelpers<MaterialValues>
    ) {
      setUpdating(true);

      const apiResponse = await put(`/materials/${id}`, values);
        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">Edit Material</h4>
            </div>
            {/* <div>
              <button
                type="button"
          ...
          <div className="card">
            <div className="card-body">
              <form className="forms-sample" onSubmit={handleSubmit}>
                ...
                <SubmitButton loading={updading} text="Update Material" />
              </form>
            </div>
          </div>
        </div>
