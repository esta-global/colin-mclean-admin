...
export function CertificationsList() {
  ...
  useEffect(
    function () {
      async function getData() {
        setLoading(true);
        let url = `/certifications?page=${pagination.page}&limit=${pagination.limit}`;
          ...
          return (
            <div className="d-flex gap-1">
              <Link
                ...
                to={{
                  pathname: `/certifications/edit/${value}`,
                }}
              >
  ...
  const data = React.useMemo(() => {
    return records.map((data) => {
      return {
        ...
        certificationIcon: addUrlToFile(data.certificationIcon),
  ...
  async function handleDeleteData(recordId: string | string[]) {
    ...
    if (Array.isArray(recordId)) {
      apiResponse = await remove(`/certifications`, recordId);
    } else {
      apiResponse = await remove(`/certifications/${recordId}`);
    }
        ...
        <div className="col-md-12 grid-margin">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex gap-2">
              <GoBackButton />
              <h4 className="font-weight-bold mb-0">Certifications List</h4>
            </div>
            <div>
              <Link
